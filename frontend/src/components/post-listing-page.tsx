        ...
        {previewMode ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Gói đăng tin</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    <RadioGroup defaultValue="free">
                      ...
                      <div className="flex items-center justify-between space-x-2 border rounded-lg p-3 border-primary bg-primary/5">
                        <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium text-primary">20.000đ/ngày</span>
                      </div>
                      <div className="flex items-center justify-between space-x-2 border rounded-lg p-3">
                        <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm font-medium">10.000đ/ngày</span>
                      </div>
                    </RadioGroup>
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="duration">Thời hạn đăng tin</Label>
